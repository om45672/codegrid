...
import { type FieldErrors, type UseFieldArrayReturn, type UseFormReturn } from "react-hook-form";
import { type z } from "zod";
import { problemSchema } from "@/modules/problems/schema";

type CreateProblemFormValues = z.infer<typeof problemSchema>;

type TestCasesSectionProps = {
  form: UseFormReturn<CreateProblemFormValues>;
  testCasesArray: UseFieldArrayReturn<CreateProblemFormValues, "testCases">;
};

type TestCaseCardProps = {
  index: number;
  register: UseFormReturn<CreateProblemFormValues>["register"];
  errors: FieldErrors<CreateProblemFormValues>;
  onRemove: () => void;
  canRemove: boolean;
};
